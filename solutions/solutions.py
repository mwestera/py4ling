"""
This file will contain solutions to (most) exercises from now on.\
I've organized them into a separate function per section, called from the main function,
so you can easily disable a section by commenting it out.
"""
